...
**JotForm Webhook(** **signupAndWaitlistHandler.py)**

We use the Jotform webhook **signupAndWaitlistHandler.py** to handle waitlist signups. It parses the Jotform submission and checks for duplicate waitlist entries using **classId + submissionId**.
...
**Lambda function (inviteUninviteUser.py)**
