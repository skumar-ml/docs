...
#### 2. Pre-Registration Checkout with any Bundle or Briefs (`checkoutUrlForUpsellProgram`)

- This API endpoint is used for Pre-regstration with the bundled Program or briefs
- Pre-registration will be finalised once the bundle purchase or a brief payment has been made.
- **_We are using this API on the portal purchase as well._**

<Note>
  **TODO: The above needs to be updated. The APIs don't function like this anymore, as best I can tell. @Dev needs to confirm.**
</Note>
...
> There are additional fields for **Pre-registration** purchases [(discussed here)](/bdc/checkout-systems/semester/pre-reg-system):
>
> - `paymentId` – **Pre-registration** payment identifier,
> - `isBundleProgram` – Boolean flag, We mantain flag for the **pre-registration**, If it's true
