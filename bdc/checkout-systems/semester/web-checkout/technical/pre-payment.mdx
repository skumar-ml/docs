...
The modal opens when the user clicks **Next**, unless it is skipped. It is skipped if at least **two checkboxes (one Core and one Bundle)** are already selected, or if the modal was dismissed within the **last 1 hour**, tracked via cookies.
...
<Info>
  Current session program. Like Winter/Spring (2026)
</Info>
