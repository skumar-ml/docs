...
The modal opens when the user clicks **Next**, unless it is skipped. It is skipped if at least **two checkboxes (One Current Session Program and One Bundle Program)** are already selected, or if the modal was dismissed within the **last 1 hour**, tracked via cookies.
