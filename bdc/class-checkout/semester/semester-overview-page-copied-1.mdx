...
## 1. Post-Payment Flow (After Successful Checkout)
...
- Stripe events such as `payment_intent.succeeded`, `checkout.session.completed`, or async bank transfer updates.

**Purpose:**

- Acts as the single entry point for all post-payment processing.

---

## 1.2 Core Logic Flow (High Level)
