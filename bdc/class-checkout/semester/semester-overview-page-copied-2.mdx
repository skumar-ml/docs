...
**2. Credit Card:** If selected, a processing fee (_approximately 2.9% + \$0.30_) is applied. Standard credit/debit card payment via Stripe

<Note>
  TODO: Why is it "approximately"???? Can we be exact
</Note>
