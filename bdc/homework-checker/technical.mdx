...
- **Usage**:
  - The BCDC portal JS (`portal_staging.js` / `portal_new_ui.js`) calls this endpoint to build the student tabs and per-student panels.
...
Homework comments are pulled by a scheduled process rather than on-demand portal requests.
