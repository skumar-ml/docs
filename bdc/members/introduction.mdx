...
Parent and student accounts are connected through a unique `familyId` that links family members together. This architecture supports multiple students **\<TODO: Why a single parent account?\>** <u>under a single parent account </u>and handles various sign-up scenarios.
