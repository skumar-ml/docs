...
<Note>
  ...
  - what happens to coach accounts trying to register for an account? **Coach can register for classes, but the family id will not generate as per the current implementation.**
