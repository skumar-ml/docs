...
- Accepts signup payload: `name`, `email`, `accountType` (student | parent | coach), `signUpRef` **TODO Can you confirm this payload is passed by Memberstack via the webhook?**
