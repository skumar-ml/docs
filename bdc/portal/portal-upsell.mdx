...
<Columns cols={2}>
  <Card title="Pre-Registration Info" icon="sparkles">
  ...
  <Card title="Pre-Registration View" icon="sparkles">
...
<Note>
  ...
  Comment: currect session `portal_program_ids` upsell programs we are showing in the portal. we are not using summer upsell program id
</Note>
...
<Note>
  ...
  1. I think some screenshots of the above will be helpful. They can be in accordions: **Added Image**
</Note>
