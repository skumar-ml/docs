...
Credits are stored in **member_credit_amount** (balance + **credit_history**). Retool adds credits (updates balance and pushes **credit** entries); Stripe webhook deducts on invoice/checkout (pushes **debit** entries). Credit Center uses **getCreditBalance/** and **credit_points.js** to show balance and sorted transaction history. The checkout-time “apply credit” modal is documented in the checkout and invoice docs.