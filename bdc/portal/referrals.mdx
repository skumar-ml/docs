...
- **POST addReferralData** (referral-promotion-service, **addReferralData.py**).
  ...
  - If **members** has existing member with that **email** and **familyId** set →  "Member already exists".\<**@DEV; Need to confirm**\>
  - If **referral_details** has doc with that **email** →  "Member already referred". \<**@DEV; Need to confirm**\>
