...
- An existing user receives a **unique referral code** and a **referral link**. They can share either the referral link or the code directly.
...
My Referrals Table - shows list of invited referrals.
