...
- If sent via email, the invited user receives an invitation email with the **\$100 discount** and a **link to Bergen’s website**. If the link is shared manually, the experience is the same—just without the system-generated email.
